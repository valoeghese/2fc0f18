...
public abstract class EcoZone {
	...
	public static final EcoZone TROPICAL_RAINFOREST = new TropicalRainforestZone(8);
	public static final EcoZone TROPICAL_RAINFOREST_EDGE = new TropicalRainforestZone(3);
